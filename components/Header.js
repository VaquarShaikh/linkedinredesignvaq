  ...
  return (
      <header className="sticky top-0 z-40 bg-white dark:bg-[#1D2226] flex items-center justify-around py-1.5 px-3 focus-within:shadow-lg">
            ...
            {mounted && (
              <>
                {resolvedTheme === "dark" ? (
                  <Image src="https://rb.gy/euvytk" width={45} height={45} />
                ) : (
                  <Image src="https://rb.gy/j5de5v" width={55} height={55} />
                )}
              </>
            )}
...
// Black : https://rb.gy/euvytk
// White : https://rb.gy/j5de5v
